  ...
  return (
    <div>
      ...
      <header>
        ...
        <nav
          className="flex-no-wrap relative flex w-full items-center justify-between bg-neutral-900 py-2 shadow-md shadow-black/5 dark:bg-neutral-800 dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-4 text-white"
          data-twe-navbar-ref
        >
